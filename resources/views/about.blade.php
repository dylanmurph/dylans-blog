...
@section('content')
    ...
    <div class="relative container mx-auto px-0 md:px-6 py-32">
        ...
        <div class="about-content max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-start">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                        <div class="flex items-center space-x-3 mb-3">
                            <svg class="hidden md:block w-6 h-6 text-green-500" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="about-image flex flex-col items-center space-y-64">
