        ...
        <section class="p-8">
            <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-white p-8 rounded-lg shadow-lg border border-gray-200">
                    <h2 class="text-2xl font-bold text-center text-gray-700 mb-2">We'd Love to Hear From You. <br>Complete the form below to contact via email.</h2>

                    <div class="text-center mb-10 mt-10 ">
                        <a href="{{ route('review-request') }}" class="w-full px-6 py-3 bg-green-700 text-white font-semibold rounded-lg hover:bg-green-500 transition duration-300">
                    ...
                    <form action="/contact" method="POST">
                        ...
                        <div class="mb-10">
                            ...
                            <textarea name="message" cols="30" rows="11" class="w-full p-3 mt-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600" required>{{old('message')}}</textarea>
                ...
                <div class="bg-white p-8 rounded-lg shadow-lg border border-gray-200">
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <p class="italic font-semibold">PJ Carroll Building<br>Dundalk Institute of Technology<br>Dundalk<br>Co.Louth<br>Ireland<br>A91 K584</p>
                        </div>
                    </div>
                </div>
            </div>
