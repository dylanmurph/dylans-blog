    ...
    @foreach ($reviews as $review)
        <div class="bg-white rounded-lg shadow-xl p-6 sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 mt-6 mb-6">
            <div class="flex justify-center items-center">
                <img src="{{ asset('images/reviews/' . $review->image_path) }}" alt="" class="max-h-96 rounded-xl shadow-2xl border-2 border-black">
            </div>
            <div class="flex flex-col">
                ...
                <br>
                <a href="/reviews/{{ $review->slug }}" class="w-56 text-center mt-auto uppercase bg-green-500 text-gray-100 text-lg font-extrabold py-4 px-8 rounded-3xl">
                    Read Full Review
                </a>
