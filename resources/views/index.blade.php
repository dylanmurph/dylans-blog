    ...
    <div class="background-image grid grid-cols-1 m-auto">
        <div class="flex text-gray-100 pt-10">
            <div class="m-auto pt-4 pb-16 sm:m-auto w-4/5 block text-center">
                <h1 class="sm:text-white-700 text-5xl uppercase font-extrabold pb-14" style="-webkit-text-stroke: 2px black; color: white;">
                    Want to build the perfect Golf Bag?
                </h1>
                
                <h2 class="sm:text-white-700 text-3xl font-extrabold" style="-webkit-text-stroke: 1px black; color: white">
    ...
    <div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
        <div class="m-auto sm:m-auto text-left w-4/5 block">
            ...
            <p class="py-8 text-gray-500 text-s">
                We do all the heavy lifting for tou.
            </p>

            <p class="font-extrabold text-gray-600 text-s pb-9">
                We review and compare the leading brands of golf clubs to help you build the perfect golf bag.
            </p>
