...
@section('content')
    ...
    <section class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
        <div class="p-6 bg-white rounded-lg shadow-lg border border-gray-200 transform scale-100 hover:scale-105 transition duration-300 max-w-full">
            ...
            @if($latestBlogPost)
                <img src="{{ asset('images/blog/' . $latestBlogPost->image_path) }}" alt="{{ $latestBlogPost->title }}" class="w-full h-64 object-cover mb-4">
        ...
        <div class="p-6 bg-white rounded-lg shadow-lg border border-gray-200 transform scale-100 hover:scale-105 transition duration-300 max-w-full">
            ...
            @if($latestNewsPost)
                <img src="{{ asset('images/news/' . $latestNewsPost->image_path) }}" alt="{{ $latestNewsPost->title }}" class="w-full h-64 object-cover mb-4">
