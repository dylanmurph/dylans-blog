...
@section('content')
    <div class="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-32">
        <div class="container mx-auto px-6">
            <!-- Header Section -->
            <div class="text-center mb-20">
                <h1 class="text-5xl font-bold bg-gradient-to-r from-green-700 to-green-500 bg-clip-text text-transparent mb-6">
                    Drivers Digest
                </h1>
                ...
                <div class="space-y-12">
                    ...
                    <div class="bg-white p-12 rounded-3xl shadow-xl hover:shadow-2xl transition-shadow duration-300">
                        ...
                        <p class="text-lg text-gray-700 leading-relaxed mb-8">
                            Founded by Dylan Murphy, we've made it our mission to revolutionize how golfers choose their equipment. With over 15 years of experience and a degree in Sports Technology, we bring technical expertise and practical knowledge to every review.
                        </p>
                    </div>
                    ...
                    <div class="bg-gradient-to-r from-green-600 to-green-500 p-12 rounded-3xl text-white shadow-xl">
                        ...
                        <p class="text-lg leading-relaxed">
                            To deliver comprehensive, unbiased reviews that combine technical analysis with real-world performance data, helping golfers of all levels make confident equipment decisions.
                        </p>
                    </div>
